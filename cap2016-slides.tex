...
\begin{frame}
	...
	\centerline{\includegraphics[width=5cm]{figs/cap-frog.png}}
	\begin{itemize}
		\item Feedback qualitatif unaire (clic, like, visit, follow, retweet ...)
	...
	\begin{columns}
		...
		\begin{column}{.8 \linewidth}
			\begin{itemize}
				...
				\item Classifieurs multiclasse ($y_t \in \{1,...,K\}$)~:
				\begin{itemize}
					\item Perte relative~:
...
\begin{frame}\frametitle{Réduction au cas du "bandit"}
	\begin{columns}
		\begin{column}{.2 \linewidth}
			\centerline{\includegraphics[width=\linewidth]{figs/cap-loss.png}}
		\end{column}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\\
		&\text{4. Mettre à jour :} 
		&& W_t = W_{t-1} + \frac{l_t}{\|x_t\|^2 + \frac{1}{2C}} (1 - 2{\color{red}f_t})\cdot X_t^{\tilde{y}_t}
		\end{align*}
	\end{block}
