...
Nous avons proposé dans cet article un nouvel algorithme d'apprentissage en ligne de classifieurs multiclasses adaptés au cas où l'information de classification se présente sous une forme binaire (on parle de feedback de bandit). Nous développons une approche fondée sur l'optimisation à chaque essai d'une fonction de coût spécifique au problème, sur le modèle de l'approche ``Passive Agressive'' proposée par \cite{crammer2006online}. 
